...
import useKeyPress from "./customHooks/useKeyPress.jsx"
function App() {
  ...
  return (
    <main className="min-h-screen bg-sky-600">
      ...
      <section className="container mx-auto flex flex-col mb-10">
        ...
        <h3 className="text-gray-800">Move your mouse to see your custom pointer!</h3>
        {customPointer}
      </section>
      <section className="container mx-auto flex flex-col mb-10">
        <h2 className="font-bold text-gray-100 text-xl text-start py-2">useKeyPress()</h2>
        <h3 className="text-gray-800">Hold 'Enter' to test your custom hook</h3>
        <p>{isEnterPressed ? "Enter clicked! ✅" : "Waiting for input... ⌨️"}</p>
      </section>
    </main>
  )
}
